...
By segment (12-month, holdout): United Kingdom WAPE 0.023 (1,193 customers) vs. Europe 0.201 (88) vs. rest of world 0.436 (14) -- the model is most accurate where it has the most data. By buyer-size tercile: high-value tercile WAPE 0.034, mid 0.006, low 0.228 -- small buyers are the hardest to call, both because their totals are small (denominator effect on WAPE) and because a few of them churn or return unpredictably. Full segment and decile tables: `outputs/metrics.json`.
